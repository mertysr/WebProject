...
class FacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create face" do
    assert_difference('Face.count') do
      post faces_url, params: { face: { baslik: @face.baslik, begeni: @face.begeni, ekleyen: @face.ekleyen, icerik: @face.icerik, ozet: @face.ozet } }
    end
  ...
  test "should update face" do
    patch face_url(@face), params: { face: { baslik: @face.baslik, begeni: @face.begeni, ekleyen: @face.ekleyen, icerik: @face.icerik, ozet: @face.ozet } }
